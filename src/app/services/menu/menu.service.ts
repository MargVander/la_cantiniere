...
export class MenuService {
  ...
  getIngredients() {
    var reqHeader = new HttpHeaders({ 
      'Content-Type': 'application/json',
      'Authorization': 'Bearer eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9..6si-gk7uuLFve9ek1tZ1vEqefgqG3RopssmGCZv3lPri9tmiQX-neAQsvYzWK6mNlb_dQ5YaJn3U9Idt1YiRag'
   });
